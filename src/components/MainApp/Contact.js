...
export default function Contact() {
  return (
    ...
    <div class="container  align-items-center">
        <div class="row">
            <div class="col-lg-12">
                <form method="post" id="signup-form" action="https://www.tintash.com/users/store">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                       ...
                       <div class="col-lg-12">
                        ...
                        <div class="col-12">
                            <div id="recaptcha" class="g-recaptcha recaptcha-margin" data-sitekey="6LdRyI8UAAAAAFZ7xNVZGrR3KEYcXoVr5mx8CSHl" data-callback="onSubmit"><div style={{ width: '304px', height: "78px" }}><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6LdRyI8UAAAAAFZ7xNVZGrR3KEYcXoVr5mx8CSHl&amp;co=aHR0cHM6Ly93d3cudGludGFzaC5jb206NDQz&amp;hl=en-GB&amp;v=v1562567553145&amp;size=normal&amp;cb=ebdcqzra9ha5" width="304" height="78" role="presentation" name="a-o9u2be7w8cn0" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style={{width: 250, height: 40, border: '1px solid rgb(193, 193, 193)', margin: '10 25', padding: 0, resize: 'none', display: "none"}}></textarea></div></div>
                        </div>
